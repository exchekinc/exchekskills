...
| 🟡 | **USML Category XI (semiconductor / circuit-board controls)** omnibus revision — 2026 agenda. | `exchek-skill-jurisdiction`, `exchek-skill` (classify ITAR/EAR boundary) | Update Cat XI guidance; re-check ITAR-vs-EAR boundary for electronics. | DDTC 2026 regulatory agenda |
