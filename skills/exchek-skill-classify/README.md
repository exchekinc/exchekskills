...
**Why use it** — U.S. export classifications (15 CFR Part 774, 22 CFR Part 121) from your agent. Free to use. Reports are suitable for compliance records and audits.
...
```bash
git clone https://github.com/exchekinc/exchekskills exchekskills
...
- **What the agent does** — Collects item details, fetches Part 774/121 data, runs classification, asks you to confirm jurisdiction and ECCN, then builds the report from the template.  
