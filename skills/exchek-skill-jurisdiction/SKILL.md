...
- **Part 121 (USML):** `mcp__exchek-api__get_ecfr_part` (`part: 121`) — USML structure for jurisdiction review.
- **Full-text search:** `mcp__exchek-api__search_ecfr_part` (`part: 121`, query) — search within USML for item-specific categories.
