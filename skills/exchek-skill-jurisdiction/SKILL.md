...
- **Part 121 (USML):** data-source gate → `get_ecfr_part` (`part: 121`) — USML structure for jurisdiction review.
- **Full-text search:** data-source gate → `search_ecfr_part` (`part: 121`, query) — search within USML for item-specific categories.
