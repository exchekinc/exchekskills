...
## 9. AI Tool Usage & Regulatory Currency Disclosure
...
- **When uncertain:** When an SOP step depends on a regulatory interpretation that is unsettled (e.g., AC/S IFRs, stayed Affiliates Rule), defer adoption until counsel has reviewed.
