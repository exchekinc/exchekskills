...
The exceptions are opt-in Enterprise features handled by the sub-skills with their own consent gates: PDF rendering and dashboard transaction sync (see exchek-skill-classify's references).
