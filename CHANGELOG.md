...
- **PDF page count reconciled to the deployed renderer** — docs and skills described the Official Classification Memorandum as a "21-page" PDF, but `create_classification_pdf` renders **~28 pages**. Updated `ENTERPRISE.md`, `exchek-classify`, `exchek-setup`, and `pdf-rendering.md` to "~28-page" (the historical 3.5.1 entry below is left as a point-in-time record).
